...
const Header = ()=>{
    ...
    return(
        <div className="flex flex-col items-center mt-20 px-4 text-center text-gray-800">
            ...
            <h2 className="text-3xl sm:text-xl font-semibold mb-4">Welcome to our app</h2>
            <p className="mb-8 max-w-md">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Provident repellat praesentium placeat, perspiciatis obcaecati repellendus? Odio veniam laboriosam ducimus sit.</p>
